  ...
  document.addEventListener("keydown", function(event) {
    ...
    if (/^[a-z]$/.test(key)) {
      ...
      if (emptyBoxIndex >= 0) {
        ...
        letterBoxes[emptyBoxIndex].classList.remove("current-letter");
        if (emptyBoxIndex + 1 < letterBoxes.length) {
          letterBoxes[emptyBoxIndex + 1].classList.add("current-letter");
        }
      }
    }
    ...
    if (event.key === 'Backspace') {
      ...
      if (filledBoxIndex >= 0) {
        ...
        letterBoxes[letterBoxes.length - 1 - filledBoxIndex].classList.add("current-letter");
        if (letterBoxes.length - 1 - filledBoxIndex + 1 < letterBoxes.length) {
          letterBoxes[letterBoxes.length - 1 - filledBoxIndex + 1].classList.remove("current-letter");
        }
      }
    }
